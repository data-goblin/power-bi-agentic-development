...
- **DAX optimization skill; Performance optimization framework and pattern catalog (DAX001–DL002):** Contributed by [Justin Martin](https://daxnoob.blog), adapted from the [powerbi-agentic-plugins](https://github.com/justinmartin_microsoft/powerbi-agentic-plugins) project.
