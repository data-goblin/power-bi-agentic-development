...
- **DAX optimization skill:** Contributed by Justin Martin; engine-internals concepts informed by the published work of Phil Seamark and [SQLBI – Marco Russo & Alberto Ferrari](https://docs.sqlbi.com/dax-internals/) ([DAX Guide](https://dax.guide/)).
